...
//   return (
//     <div className="min-h-screen text-black my-8 flex items-center justify-center  px-10">
...
const Login = () => {
  ...
  const {
    ...
    formState: { errors },
    reset,
    setValue, // ✅ use setValue to programmatically fill form fields
  } = useForm();
  ...
  const fillCredentials = (role) => {
    if (role === "admin") {
      setValue("email", "arzooahmed0170609@gmail.com");
      setValue("password", "Aa123@");
    } else if (role === "manager") {
      setValue("email", "showrov@gmail.com");
      setValue("password", "Aa123@");
    } else if (role === "user") {
      setValue("email", "arif@gmail.com");
      setValue("password", "Aa123@");
    }
  };
          ...
          <div className="card bg-white w-full max-w-md shadow-2xl p-6 rounded-2xl">
            ...
            <div className="flex justify-between mb-4 gap-2">
              ...
              <button
                ...
                className="btn bg-yellow-500 text-white flex-1"
              >
                Manager
              </button>
              <button
                ...
                className="btn bg-green-500 text-white flex-1"
              >
                User
              </button>
            </div>
