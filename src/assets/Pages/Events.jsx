...
//                   className="mt-auto w-full bg-gradient-to-r from-blue-600 to-blue-500 text-white py-2 rounded-xl font-semibold shadow-md hover:from-blue-700 hover:to-blue-600 transition-all"
//                 >
//                   Register Now
//                 </button>
//               </div>
